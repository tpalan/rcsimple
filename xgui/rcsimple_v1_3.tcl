...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BS_LENGTH_BITS" -parent ${Page_0}
...
proc update_PARAM_VALUE.BS_LENGTH_BITS { PARAM_VALUE.BS_LENGTH_BITS } {
	# Procedure called to update BS_LENGTH_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BS_LENGTH_BITS { PARAM_VALUE.BS_LENGTH_BITS } {
	# Procedure called to validate BS_LENGTH_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.BS_LENGTH_BITS { MODELPARAM_VALUE.BS_LENGTH_BITS PARAM_VALUE.BS_LENGTH_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BS_LENGTH_BITS}] ${MODELPARAM_VALUE.BS_LENGTH_BITS}
}
